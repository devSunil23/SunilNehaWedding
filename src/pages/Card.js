        ...
        <div className="min-h-screen bg-gradient-to-r from-violet-500 to-fuchsia-500 py-20 px-3">
            ...
            <div className="bg-white-700 text-sm text-white text-center inset-x-0 bottom-0 p-9">
                ...
                <footer className="text-stone-300 mt-5 opacity-70">
                    Created with 💙 by
                    <a
                        href="mailto:me.izatyproject@gmail.com"
                        className="text-stone-300 underline decoration-orange-800 hover:text-brown-300">
                        {" "}
                        Sunil Kumar{" "}
                    </a>
                    <p className="">
                ...
                <svg
                    ...
                    class="icon icon-tabler icon-tabler-arrow-down-circle mx-auto mt-2 animate-bounce"
                    width="32"
                    height="32"
                    viewBox="0 0 24 24"
                    stroke-width="1.5"
                ...
                <p className="text-neutral-800 opacity-90 ">Scroll Down</p>
            </div>
        </div>
    );
}
