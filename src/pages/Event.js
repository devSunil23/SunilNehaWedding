    ...
    return (
        <div className="text-md text-center mt-7 mb-0 font-normal text-brown-250 leading-relaxed">
            ...
            <div className="text-md font-extrabold text-center my-7">
                ...
                <p className="bg-clip-text font-medium text-transparent bg-gradient-to-r from-white to-violet-500">
                    Daga, Bargawan (Singrauli,M.P.)
                </p>
            </div>
            <iframe
                className="object-center mt-2 mb-7 mx-auto"
                title="Maps"
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d29117.378412843445!2d82.43370039740822!3d24.183222815774773!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x398f45c80879ad99%3A0x98a334757192f25!2sDaga%2C%20Madhya%20Pradesh%20486892!5e0!3m2!1sen!2sin!4v1706410560288!5m2!1sen!2sin"
                width="360"
                height="360"
                allowFullScreen=""
                loading="lazy"></iframe>
            ...
            <div className="text-md text-center mt-3 mb-7 font-normal leading-relaxed bg-clip-text text-transparent bg-gradient-to-r from-stone-200 to-yellow-100 ">
                <p className="flex space-x-4 justify-center mx-auto text-yellow-100">
                    <svg
                        ...
                        class="svg-inline--fas fa-hands-wash w-9 h-9 mt-5"
                        role="img"
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 512 512">
                        <path
                    ...
                    <svg
                        ...
                        focusable="false"
                        data-prefix="fas"
                        data-icon="hands-wash"
                        className="svg-inline--fas fa-hands-wash w-10 h-10 mt-5"
                        role="img"
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 576 512">
                        <path
                    ...
                    <svg
                        ...
                        class="svg-inline--fa fa-people-arrows fa-w-18 w-10 h-10 mt-5"
                        role="img"
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 576 512">
                        <path
                    ...
                    <svg
                        ...
                        class="svg-inline--fa fa-handshake-slash fa-w-20 w-10 h-10 mt-5"
                        role="img"
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 640 512">
                        <path
            ...
            <div className="mb-8">
                <p className="bg-clip-text text-md font-bold text-transparent bg-gradient-to-r from-pink-700 to-white">
                    Sunil
                    <p>&</p>
                    <p>Neha</p>
                </p>
